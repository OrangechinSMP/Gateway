...
public class CarmapoModel<T extends Entity> extends SmallBipedalModel<T> {
    public static final EntityModelLayer CARMAPO = new EntityModelLayer(Identifier.of(Gateway.MOD_ID, "carmapo"), "main");
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData RIGHT_WING = modelPartData.addChild("right_wing", ModelPartBuilder.create().uv(20, 8).cuboid(-1.5F, -1.0F, -1.0F, 2.0F, 6.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(-2.25F, 13.0F, 0.0F));
