...
public class OriginSkeletonFollowOwnerGoal extends Goal {
    ...
    public OriginSkeletonFollowOwnerGoal(OriginSkeletonEntity tameable, double speed, float minDistance, float maxDistance, boolean leavesAllowed) {
