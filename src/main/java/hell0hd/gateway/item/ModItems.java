...
import hell0hd.gateway.item.custom.GuitarItem;
...
public class ModItems {
    ...
    public static final Item GUITAR = registerItem("guitar", new GuitarItem(8, -3.0f, new Item.Settings().maxCount(1).rarity(Rarity.EPIC)));
    ...
    private static void addItemsToToolsItemGroup(FabricItemGroupEntries entries) {
        entries.add(BLIND_EYE); entries.add(MUSIC_DISC_DROOPY); entries.add(MUSIC_DISC_EIGHTH); entries.add(MUSIC_DISC_DOG); entries.add(COMMUNICATOR); entries.add(MUSIC_DISC_ELEVEN); entries.add(GUITAR);
    }
