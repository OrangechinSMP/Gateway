...
public class ModItems {
    ...
    private static void addItemsToToolsItemGroup(FabricItemGroupEntries entries) {
        entries.add(BLIND_EYE); entries.add(MUSIC_DISC_DROOPY); entries.add(MUSIC_DISC_EIGHTH); entries.add(MUSIC_DISC_DOG); entries.add(MUSIC_DISC_ELEVEN); entries.add(GUITAR);
    }
